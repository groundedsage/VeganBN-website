...
(rum/defc what-we-do []
  [:div
   ...
   (molecule/blurb-title-second {:image "photos/road.jpg"
                                 :alt-text "Cafe"
                                 :title "Road"
                                 :text [:p "We have so many plans and exciting things we are eager to show you. If you would like to sta in the loop don't forget to sign up to our mailing list"]
                                 :cta "Sign me up"})])
