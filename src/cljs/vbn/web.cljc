...
(s/defstyle style [".container" {:color 'yellow}])
...
"]
   ...
   [:div.block-grey.full-width
    [:div.inside-block
     [:h2 {:class-name (:container style)}"We have two guiding principles"]
